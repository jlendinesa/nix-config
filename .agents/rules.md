...
- **Minimize Build Commands**: Avoid running `home-manager build` or manual `nix-build`/`nix build` commands whenever possible. Always prefer switching directly using `hms` or `hmsupdate`.
